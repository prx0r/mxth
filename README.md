...
- File descriptions and hashes: [`MANIFEST.md`](MANIFEST.md)
- Machine-friendly checksums: [`SHA256SUMS`](SHA256SUMS)

## Evolution

| Release | Main contribution |
|---|---|
| `mathartist-v1` | Deterministic grayscale generative artists, declared mutations, provenance levels |
| `mathartist-lab-v2` | Source adapters for NS26, bioelectric models, Lenia, Paper2Agent, pyribs and BETSE |
| Suite `v0.3.0` / `v1.0.0` | Working Lenia, Chladni, bioelectric and derived NS26 families; SQLite event log and feeds |
| Suite `v2.0.0` / `v2.1.0` | Causal-file hashing, Paper2Agent handoff, archive search and formal aesthetics experiments |
| Suite `v3.0.0` | Evidence-backed control surface `theta`; frozen model `M(theta)` and deliberately simple search |
